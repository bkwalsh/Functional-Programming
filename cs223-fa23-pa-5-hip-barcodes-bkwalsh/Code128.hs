      ...
      accumulators' where
        ...
        bEncodings' =
          case _bValue of
            ...
            [x] -> Map.insert x  symbolId bEncodings
            _ -> bEncodings
        ...
        bDecodings' =
          case symbolId of
            12 -> Map.insert symbolId (Left ',')  bDecodings
            0 -> Map.insert symbolId (Left ' ')  bDecodings
            _ -> Map.insert symbolId (readBValue _bValue) bDecodings
