...
/* package maze-solver-0.1.0.0 */
#ifndef VERSION_maze_solver
#define VERSION_maze_solver "0.1.0.0"
#endif /* VERSION_maze_solver */
#ifndef MIN_VERSION_maze_solver
#define MIN_VERSION_maze_solver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_maze_solver */
...
#define CURRENT_COMPONENT_ID "maze-solver-0.1.0.0-inplace-maze-solver"
